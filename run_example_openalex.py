#!/usr/bin/env python3
"""
Launcher script for the OpenAlex example application.

This script serves as an entry point to run the example_openalex.py script from 
...
Without this launcher, executing src/example_openalex.py directly would result
in a ModuleNotFoundError due to Python import system limitations.

Usage:
    Run this script from the project root directory:
    $ python run_example_openalex.py
"""
import asyncio
import os
import sys
...
from src.example_openalex import main
